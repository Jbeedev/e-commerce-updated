...
import SlideImg5 from "../assets/Images/What-we-do-tenplus.png";
import SlideImg6 from "../assets/Images/app-logo-type.png";
    ...
    <div>
      ...
      <div>
        <div class="aj-slide ">
          ...
          <div class="caro-img homepage-slide">
            <img src={SlideImg1} alt="web development company near me" />
            <div class="index-banner-section">
              <div class="col-md-12 col-sm-12">
                <h1 class="banner-h1">
                  CUTTING EDGE <br /> DIGITAL SOLUTIONS
                </h1>
                <h6 class="banner-p2">within reach</h6>
                <h6 class="banner-p1">
                  discover the fastest, <br /> most effective way <br /> to get
                  experts for your needs{" "}
                </h6>
                <div class="cont-banner-buttons">
                  <a href="order" class="aj-request hvr-bounce-to-right  mr-3">
                    REQUEST A QUOTE
                  </a>
                  <a href="contact" class="aj-contact hvr-bounce-to-right  ">
                    LET'S TALK
                  </a>
                </div>
              </div>
          ...
          <div class="caro-img homepage-slide">
            <img src={SlideImg2} alt="web development company in nigeria" />
            <div class="index-banner-section">
              <div class="col-md-12 col-sm-12">
                <h1 class="banner-h1">
                  CUTTING EDGE <br /> DIGITAL SOLUTIONS
          ...
          <div class="caro-img homepage-slide">
            <img src={SlideImg3} alt="web development company near me" />
          ...
          <div class="caro-img homepage-slide">
            <img src={SlideImg4} alt="web development company in nigeria" />
            <div class="index-banner-section">
              <div class="col-md-12 col-sm-12">
                <h1 class="banner-h1">
                  CUTTING EDGE <br /> DIGITAL SOLUTIONS
      ...
      <div class="container my-3 py-4  our-mission-box">
        <div class="row">
          <div
            class="col-md-5 offset-md-1  wow animate__fadeInLeft"
            data-wow-duration=".5s"
            data-wow-delay="0s"
          >
            <h2 class="index-service">
          ...
          <div
            class="col-md-5 offset-md-1  wow animate__fadeInRight"
            data-wow-duration=".5s"
            data-wow-delay="0s"
          >
            <div>
              <img src={SlideImg5} class="service-mission-img" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid cont-vision">
        <div class="row">
          <div
            class="col-md-5 offset-md-1 wow animate__fadeInLeft"
            data-wow-duration=".5s"
          ...
          >
            <div class="our-mission-cont">
              <h2 class="h-mission-h2 hvr-underline-from-center ">
                OUR MISSION
              </h2>
              <ul>
                <li>
                ...
                <li>
                  {" "}
                  To Promote African Development by encouraging Business Sector
          ...
          <div
            ...
            data-wow-delay=""
          >
            <div class="our-vision-cont">
              <h2 class="h-mission-h2 hvr-underline-from-center ">
                OUR VISION
              </h2>
              <ul>
                <li> To be the best Innovative Company in Nigeria</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div
        class="container-fluid world-map-cont wow animate__fadeIn"
      ...
      >
        <div class="row">
          <div class="col-md-8">
            <div
              class="service-circle-bg"
              style={{ backgroundImage: `url(${WorldMap})` }}
            >
              <div class="row">
                <div class="col-md-12">
                  <div class=" active-click cont-service-a  web">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-globe  pr-1"></i> Web Development{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>

                <div class="col-md-6">
                  <div class=" active-click cont-service-b  app">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fab fa-app-store  pr-1"></i> Mobile App
                      Development<i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>

                <div class="col-md-5 offset-md-1 ">
                  <div class=" active-click cont-service-c  graphics">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-crop  pr-1"></i> Graphics Design{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  <div class=" active-click cont-service-d ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-print  pr-1"></i> Prints Services{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5 offset-md-2">
                  <div class=" active-click cont-service-e ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-bullhorn  pr-1"></i> Digital Marketing{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class=" active-click cont-service-f ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-book  pr-1"></i> Project Management{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="cont-service-img ">
                    <img src={SlideImg6} class="  cont-service-img2" alt="" />
                  </div>
                </div>

                <div class="col-md-4">
                  <div class=" active-click cont-service-g ">
                    <p class="hvr-forward">
                      <i class="fa fa-globe pr-1"></i> Data Science{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  <div class=" active-click cont-service-h ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-file-video-o  pr-1"></i> Video Editing{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5 offset-md-2">
                  <div class=" active-click cont-service-i ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-lock  pr-1"></i> Cyber Security{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  <div class=" active-click cont-service-j ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-bitcoin  pr-1"></i> Blockchain{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-5 offset-md-2">
                  <div class=" active-click cont-service-k ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-calendar  pr-1"></i> IT Consulting{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class=" active-click cont-service-l ">
                    <p class="hvr-forward">
                      {" "}
                      <i class="fa fa-desktop  pr-1"></i> IT Training{" "}
                      <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                    </p>
                  </div>
                </div>
          ...
          <div class="col-md-4 ">
            <div class="cont-right-service-div">
              <div id="serve-div-default">
                <h2 class="service-h2">
                ...
                <p class="serv-learn-m-btn">
                  {" "}
                  <a class="hvr-bounce-to-right" href="">
                    Learn more <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                  </a>
                </p>
              </div>

              <div class="cont-right-service-div-2" id="serve-div-a">
                <h2 class="service-h2">Web Development</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-b">
                <h2 class="service-h2">Mobile App Development</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-c">
                <h2 class="service-h2">Graphics Design</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-d">
                <h2 class="service-h2">Prints Services</h2>
                <p class="service-par">
                ...
                <p class="serv-learn-m-btn">
                  {" "}
                  <a class="hvr-bounce-to-right" href="printing.html">
                    Learn more <i class="fa fa-arrow-circle-right  pl-2"></i>{" "}
                  </a>
                </p>
              </div>

              <div class="cont-right-service-div-2" id="serve-div-e">
              ...
              <div class="cont-right-service-div-2" id="serve-div-f">
                <h2 class="service-h2">Project Management</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-g">
                <h2 class="service-h2">Data Science and Machine Learning</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-h">
                <h2 class="service-h2">Video Editing</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-i">
                <h2 class="service-h2">Cyber Security</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-j">
                <h2 class="service-h2">Blockchain</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-k">
                <h2 class="service-h2">IT Consulting</h2>
                <p class="service-par">
              ...
              <div class="cont-right-service-div-2" id="serve-div-l">
                <h2 class="service-h2">IT Training</h2>
                <p class="service-par">
      ...
      <div class="service-only-mobile-d">
                      ...
                      <div class="row mb-3">
                        <div class="col-md-5 offset-md-1">
                          <a
                            ...
                            class="service-tab-box hvr-bounce-to-right"
                  ...
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i>Mobile App Development
                        </button>
                      </h2>
                    </div>
                    <div
                  ...
                  <div class="card">
                    <div class="card-header" id="heading-4">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i> Prints Services
                        </button>
                      </h2>
                    </div>
                    <div
                  ...
                  <div class="card">
                    <div class="card-header" id="heading-6">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i>Project Management
                        </button>
                      </h2>
                    </div>
                    <div
                  ...
                  <div class="card">
                    <div class="card-header" id="heading-8">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i>Video Editing
                        </button>
                      </h2>
                    </div>
                    <div
                  ...
                  <div class="card">
                    <div class="card-header" id="heading-10">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i>Blockchain
                        </button>
                      </h2>
                    </div>
                    <div
                  ...
                  <div class="card">
                    <div class="card-header" id="heading-12">
                      <h2 class="mb-0">
                        ...
                        >
                          <i class="fa fa-plus"></i>IT Training
                        </button>
                      </h2>
                    </div>
                    <div
      ...
      <div class="container-fluid cont-choose-w">
        <div class="text-center">
          <h2
            class="why-you-choose hvr-underline-from-center wow animate__fadeInDown"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 offset-md-1 container-box-w">
              <p
              ...
              >
                {" "}
                <i class="fa fa-long-arrow-right h-arrow-rt  fa-lg"></i>
            ...
            <div class="col-md-5 offset-md-1 container-box-w">
              ...
              >
                {" "}
                <i class="fa fa-long-arrow-right h-arrow-rt fa-lg"></i>Plan For
                success
              </p>
            </div>
            <div class="col-md-5 offset-md-1 container-box-w">
              ...
              >
                {" "}
                <i class="fa fa-long-arrow-right h-arrow-rt  fa-lg"></i>Expert
                Delivery
              </p>
            </div>
            <div class="col-md-5 offset-md-1 container-box-w">
              ...
              >
                {" "}
                <i class="fa fa-long-arrow-right h-arrow-rt fa-lg"></i>Deliver
                on Schedule
              </p>
            </div>
          </div>
      ...
      <div class="container rounded testimonial-cont">
        <h2
          class="text-center h-testominial-h2 hvr-underline-from-center wow animate__fadeInDown"
          data-wow-duration=".5s"
          data-wow-delay="0.1s"
        >
          TESTIMONIAL
        ...
        <div class="owl-carousel owl-theme">
          <div
            class="owl-item wow animate__fadeIn"
          ...
          >
            <div class="card d-flex flex-column">
              ...
              <div class="main head-review pb-2 pt-1">Great Service</div>
              ...
              <div class="d-flex flex-row profile pt-4 mt-auto">
                {" "}
                <img src={Testimonial1} alt="" class="rounded-circle" />
                <div class="d-flex flex-column pl-2">
                  <div class="name">Adekunle </div>
                  <p class="text-muted designation">CEO of Brand O Textiles</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="card d-flex flex-column">
              ...
              <div class="d-flex flex-row profile pt-4 mt-auto">
                {" "}
                <img src={{ Testimonial2 }} alt="" class="rounded-circle" />
                <div class="d-flex flex-column pl-2">
                  <div class="name">Abdulkareem Age</div>
          ...
          >
            <div class="card d-flex flex-column">
              ...
              <div class="d-flex flex-row profile pt-4 mt-auto">
                {" "}
                <img src={Testimonial3} alt="" class="rounded-circle" />
                <div class="d-flex flex-column pl-2">
                  <div class="name">Toria Ubani</div>
                  <p class="text-muted designation">CEO of Tee Fashion</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="cont-mind-project text-center">
        <h4
          class="h4-project-port wow animate__fadeInLeft"
          data-wow-duration=".5s"
        >
          {" "}
        ...
        <p
          class="p-project-port wow animate__fadeInRight"
          data-wow-duration=".5s"
        >
        ...
        <div class="text-center mt-4">
          <a
            href="order.html"
            class="talk-to-box hvr-bounce-to-right wow animate__fadeInUp"
            data-wow-duration="2s"
          >
            Talk to Us
          </a>
      ...
      {/* <!-- partners --> */}
      <img class="" alt="web development company near me" src={{ SlideImg6 }} />
      <div class="container-fluid my-5 ">
